    ...
    return (<Container className={classes.container} maxWidth="xl">
        ...
        <Box className={classes.boxForm}>
            <Grid container spacing={3} >
                ...
                <Grid item>
                    <form onSubmit={handleSubmit}>
                        ...
                        <OutlinedInput className={classes.outlinedInput} onChange={onEmailChange} value={email} required type="text" variant="outline" />
                        <FormHelperText className={classes.formhelperText}>Password</FormHelperText>
                        <OutlinedInput className={classes.outlinedInput} onChange={onPasswordChange} value={password} required type="password" variant="filled" />
            ...
            <Typography align="left" variant="caption">
                By creating an account, you agree to Indeed's <Link to="/" style={{ textDecoration: "none", color: "#085ff8" }} >Terms of Service</Link>, <Link to="/" style={{ textDecoration: "none", color: "#085ff8" }} >Cookie Policy</Link><br />
